    ...
    <div class="bg-white rounded-lg shadow-sm overflow-hidden border border-gray-200">
        <div class="p-5 border-b border-gray-200 bg-gray-50 flex items-center justify-between">
                ...
                <div class="flex gap-3 items-center w-full md:w-auto">
                    <form action="{{ route('admin.users.index') }}" method="GET" class="flex w-full md:w-80">
                        <input type="text" name="search" value="{{ request('search') }}" placeholder="Cari nama, email, atau role"
                            class="w-full px-3 py-2 text-sm border border-gray-300 rounded-l-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                        <button type="submit"
                            class="bg-gray-800 hover:bg-gray-900 text-white px-4 py-2 rounded-lg text-sm font-semibold rounded-r-lg transition">
                            Cari
                        </button>
                        @if(request('search'))
                            <a href="{{ route('admin.users.index') }}"
                                class="ml-2 bg-gray-300 hover:bg-gray-400 text-gray-700 px-3 py-2 rounded-lg text-sm flex items-center transition" title="Reset Pencarian">
                                Reset
                            </a>
                        @endif
                    </form>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="text-gray-700 text-sm">
                        ...
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="py-3 px-4 border-b">
                                <div class="flex space-x-2">
                                    ...
                                    class="bg-sky-500 hover:bg-sky-600 text-white px-3 py-1.5 rounded text-xs font-semibold transition">
                                        Lihat
                                    </a>
                    ...
                    @empty
                        <tr>
                            <td colspan="3" class="py-4 text-center text-gray-500">Belum ada pengguna.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
