...
class AdminController extends Controller
{
    ...
    // Menampilkan riwayat pengembalian + daftar peminjaman yang belum dikembalikan
    public function indexPengembalian(Request $request)
    {
        ...
        return view('admin.pengembalian.index', compact('pengembalians', 'search', 'peminjamanAktif', 'searchAktif'));
    }
        ...
        public function destroyPengembalian($id)
        {
            ...
            try {
                ...
                DB::commit();
                return redirect()->route('admin.pengembalian.index')->with('success', 'Data pengembalian dihapus, status peminjaman dikembalikan ke "Dipinjam".');
            } catch (\Exception $e) {
                DB::rollBack();
                return redirect()->back()->with('error', 'Terjadi kesalahan: ' . $e->getMessage());
            }
